        ...
        return new SelfValidatingPassport(
                new UserBadge($accessToken->getToken(), function() use ($accessToken, $client) {
                    ...
                    $existingUser = $this->entityManager
                            ...
                            ->findOneBy(['keycloak_clientid' => $keycloakUser->getId()]);
                    if($existingUser){
                        return $existingUser;
                    }
                    ...
                    if($userInDatabase){
                        $userInDatabase->setKeycloakClientid($keycloakUser->getId());
                    ...
                    $user = new User();
                    $user->setKeycloakClientid(($keycloakUser->getId()));
